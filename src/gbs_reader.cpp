...
void GBSReader::print_metadata(bool verbose) {
	if (verbose) {
		std::cout << "GBS version:      "
				  << static_cast<unsigned int>(content.version) << "\n";
		std::cout << "Song count:       "
				  << static_cast<unsigned int>(content.num_songs) << "\n";
		std::cout << "First song:       "
				  << static_cast<unsigned int>(content.first_song) << "\n";
		std::cout << std::hex;
		...
		std::cout << "Timer modulo:     0x"
				  << static_cast<unsigned int>(content.timer_modulo) << "\n";
		std::cout << "Timer control:    0x"
				  << static_cast<unsigned int>(content.timer_control) << "\n";
		std::cout << std::dec;
	}
